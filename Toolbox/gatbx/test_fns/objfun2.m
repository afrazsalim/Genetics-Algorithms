...
%
% Syntax:  ObjVal = objfun2(Chrom,switch_)
%
% Input parameters:
...
%    switch_    - if Chrom == [] and switch_ == 1 (or []) then return
%                boundaries, if switch_ == 2 return title
%
% Output parameters:
...
function ObjVal = objfun2(Chrom,switch_);
